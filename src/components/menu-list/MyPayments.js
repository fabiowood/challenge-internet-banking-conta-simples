...
class ChargeCounterparts extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <Fragment>
               ...
               <p className='path-text custom-text-menu'><b>Você está em: Sua-Conta-Simples >> Pagamentos >> Efetuar Pagamentos</b></p>
...
export default ChargeCounterparts;