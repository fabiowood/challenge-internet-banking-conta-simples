...
class MyBankDeposits extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <Fragment>
               ...
               <p className='path-text custom-text-menu'><b>Você está em: Sua-Conta-Simples >> Meus Depósitos</b></p>
