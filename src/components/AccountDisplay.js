          ...
          {this.props.accountData.operations.sort((a, b) => {
                ...
                if (a.effectiveTransactionDate.day < b.effectiveTransactionDate.day) {
                    return 1;
                      ...
                      }).filter((operation, index) => index <= 5)
           }
           <button className="button-styles" id='bank-state-button' onClick={() => this.props.expandTransactions()}>Extrato Completo</button>
        ...
        {this.props.accountData.operations.sort((a, b) => {
              ...
              if (a.dueDate.day < b.dueDate.day) {
                  return 1;
                    ...
                    }).filter((operation, index) => index <= 15)
           }
           <button className="button-styles" id='bank-state-button' onClick={() => this.props.expandTransactions()}>Extrato Completo</button>
      </Fragment>
